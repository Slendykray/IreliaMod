...
namespace IreliaMod.Survivors.Irelia.SkillStates
{
    public class Dash : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.overlapAttack = base.InitMeleeOverlap(IreliaStaticValues.dashDamageCoefficient, null, base.GetModelTransform(), "SwordGroup");
            ...
            //delete vfx solve!!!!!!
            GameObject dashEf = UnityEngine.Object.Instantiate(IreliaAssets.dashEffect, characterBody.corePosition, Util.QuaternionSafeLookRotation(dashVector), transform);
